...
# Уведомления:
#  - Подтверждение электронной почты (единичное, мгновенное) [канал: email]
#  - Подтверждение телефона (единичное, мгновенное) [канал: sms]
#  - Статус платежа подписки, чек об оплате (единичное, мгновенное) [канал: email, websocket]
#  - Рекламные уведоления созданные менеджерами (единичное, мгновенное) (канал: email, websocket]
#  - Уведомления о новых фильмах и сериалах (единичное, мгновенное) [канал: email, websocket]
#  - Уведомления о ТОП-10 фильмов недели (периодическое по расписанию) [канал: email, websocket]
#  - Уведомления о новых лайках рецензии пользователя (единичное, отложенное) [канал: email, websocket]